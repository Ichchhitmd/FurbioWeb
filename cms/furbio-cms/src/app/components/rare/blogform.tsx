  ...
  return (
    ...
    <div className="relative w-full max-w-3xl bg-white shadow-lg rounded-lg p-8">
      <div className="absolute top-4 left-4">
        <BackButton handlePress={handlePress}  title="Back" >Back</BackButton>
      </div>
  
      <div className="text-center mb-6">
        <h1 className="text-3xl font-semibold text-gray-800">Add a New Blog</h1>
        <p className="text-gray-500">Share your latest thoughts and updates!</p>
      </div>
      ...
      <form className="space-y-8">
        ...
        <div className="">
          <input type="file" className="p-3 border border-gray-300 bg-gray-50 rounded-lg w-full focus:ring-2 focus:ring-blue-500 focus:outline-none mt-8" />
        </div>
